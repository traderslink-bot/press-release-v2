...
function inferDilutionTriggerType(rawType, combinedText) {
  ...
  if (/(not yet effective|after effectiveness|upon effectiveness|until effective|until effectiveness|declared effective|effective date)/i.test(combinedText)) {
...
function buildTraderDilutionTiming({
  ...
  const todayDateKey = getCurrentEasternDateKey();
